...
public class BLEManagerConnect {
    BLEManagerConnectCallerInterface caller;
    Context context;

    public BLEManagerConnect(BLEManagerConnectCallerInterface caller, Context context) {
        this.caller = caller;
        ...
        try{
            device.connectGatt(this.context, false, new BluetoothGattCallback() {
                ...
                public void onConnectionStateChange(BluetoothGatt gatt,
                    ...
                    caller.onConnectionStateChange(gatt, status, newState);
